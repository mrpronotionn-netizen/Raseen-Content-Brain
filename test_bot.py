...
# استيراد خط الإنتاج والرفع إلى تيك توك
from run_pipeline import run_raseen_pipeline
            ...
            if text:
                ...
                if not idea_title or text == "/start":
                    send_telegram_message(
                        "👋 **أهلاً بك في نظام رصين للتحكم الذكي**\n\n"
                ...
                # 1. تشغيل المحرك المباشر
                pipeline_result = run_raseen_pipeline(
                ...
                # 2. توليد أصول الفيديو
                video_path = pipeline_result.get("video_path")
                if not video_path:
                ...
                # 3. الرفع الفعلي لـ TikTok Inbox
